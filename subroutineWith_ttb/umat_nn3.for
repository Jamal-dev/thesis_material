...
! model6_output_layer.bias
     ...
     1         + DFGRD0(2, 3)*DFGRD0(3, 3)
      ...
      !end do
      !
      !print *, "After modification B_sym="
     ...
     * model6_b5, C4row6)
      ...
      C4ten2(6,5) = C4row6(5)
      C4ten2(6,6) = C4row6(6)
      !print *,"C4ten2(1,:)=",C4ten2(1,:)
      !print *,"C4ten2(2,:)=",C4ten2(2,:)
      !print *,"C4ten2(3,:)=",C4ten2(3,:)
      !print *,"C4ten2(4,:)=",C4ten2(4,:)
      !print *,"C4ten2(5,:)=",C4ten2(5,:)
      !print *,"C4ten2(6,:)=",C4ten2(6,:)
     ...
     * model6_b1, model6_b2, model6_b3, model6_b4, model6_b5)
      ...
      !DO K1=1, NTENS
      !  DO K2=1, NTENS
      !    DDSDDE(K1, K2)=(DDSDDE(K1, K2) +DDSDDE(K2, K1))*0.5D0 
      !  END DO
      !END DO
      ...
      ! for writing other symmetric part
      !DO K1=1, NTENS
      !  DO K2=1, K1-1
      ...
      !DO K1=1, NTENS
      !  DO K2=1, NTENS
      !    DDSDDE(K1, K2)=DDSDDE(K1, K2) + eps_d
      !  END DO
      !END DO
